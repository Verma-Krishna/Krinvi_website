...
<div className="bg-white flex flex-col lg:flex-row justify-evenly mt-16 py-8">
  ...
  <div className="flex flex-col items-center lg:flex-row lg:justify-evenly gap-6 text-white pt-10">
    <div className="flex flex-col mb-8 lg:mb-0">
      ...
      <h3 className='text-md lg:text-lg font-Inter font-medium mb-1'>About Us</h3>
      <h3 className='text-md lg:text-lg font-Inter font-medium mb-1'>Contact Us</h3>
      <h3 className='text-md lg:text-lg font-Inter font-medium mb-1'>FAQ</h3>
    </div>
    <div className="flex flex-col mb-8 lg:mb-0">
      <h1 className='mb-6 lg:mb-10 text-2xl lg:text-3xl font-Inter font-medium'>Customer Service</h1>
      <h3 className='text-md lg:text-lg font-Inter font-medium mb-1'>Return & Refund Policy</h3>
      <h3 className='text-md lg:text-lg font-Inter font-medium mb-1'>Privacy Policy</h3>
      <h3 className='text-md lg:text-lg font-Inter font-medium mb-1'>Terms & Conditions</h3>
    </div>
    <div className="flex flex-col mb-8 lg:mb-0">
