    ...
    <>
      ...
      <div className="flex flex-wrap justify-evenly items-center">
        <div className="mt-6 flex flex-col justify-center items-center">
          <img src="b1im2.png" className="border w-72  rounded-xl shadow-2xl h-[60vh] bg-cover bg-center transition-transform duration-500 ease-in-out hover:scale-105 hover:bg-[#BFEDFA]" />
